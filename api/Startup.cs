...
namespace api
{
    public class Startup
    {
        ...
        {
            var client = new MongoClient(Configuration["ConnectionStrings_Mongo"]?? Configuration["ConnectionStrings:Mongo"]);
            ...
            services.AddScoped<IImageRepository, ImageRepository>(provider => new ImageRepository(
                ...
                Configuration["Paths:SavedImages"], provider.GetService<ILogger<ImageRepository>>()));
